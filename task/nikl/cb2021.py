...
class CB2021Generator(BaseGenerator):
    ...
    def __init__(self) -> None:
        ...
        self.labels = {
            "함의": ["함의", "함의관계", "함의하고 있다", "수반", "수반관계", "동반관계", "동시에 일어나다", "함께하는 관계", "포함하는 문장"],
    ...
    def generate(self, split: str):
        dataset = load_dataset("iknow-lab/nikl_cb_2021_v1.1", split="train").train_test_split(0.1, seed=42)[split]
