...
class aihubBCC1N2to3SummaryGenerator(BaseGenerator):
    def __init__(self) -> None:
        super().__init__()
        self.topicList = []
        self.instructions = [
            "대본을 읽고 적절한 요약문을 생성하세요.",
            "다음 대본을 2~3 문장으로 요약해주세요.",
            "다음 대본을 둘 또는 세 문장으로 줄여보세요",
            "다음 대본을 이해하고 요약해보세요.",
    ...
    def generate(self, split: str):
        dataset = load_dataset(
            "iknow-lab/aihub_BCC1N2to3Summary", split=split, use_auth_token=True
        ).shuffle(seed=42)
