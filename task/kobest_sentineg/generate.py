...
class KobestBoolqGenerator(BaseGenerator):
    def __init__(self) -> None:
        ...
        self.positives = ["좋은 평가입니다.", "긍정적인 내용입니다.",
                          "좋습니다.", "긍정문입니다.", "우수입니다.", "긍정적인 표현입니다.", "만족스럽습니다."]
        self.negatives = ["나쁜 평가입니다.", "부정적인 내용입니다.",
                          "별로입니다.", "부정문입니다.", "미흡합니다.", "부정적인 표현입니다.", "불만족스럽스니다."]
        self.instruction = [
            "다음 문장인 긍정적인지 부정적인지 분류하세요.",
